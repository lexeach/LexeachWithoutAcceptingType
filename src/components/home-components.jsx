...
import { ICU, BEP20, USDT, EXAM } from "../utils/web3";
...
const Dashboard = () => {
  ...
  useEffect(() => {
    async function user_detail() {
      ...
      // console.log("call success", subAdmin);
      ...
      const result = await window.ethereum.request({
        ...
        params: {
          ...
          options: {
            ...
            decimals: 18,
            image:
              "https://main.d2n1pq6gioa1qy.amplifyapp.com/static/media/logo.a231a7e78d782a87c752.png",
          },
        },
      });
  ...
  const handleSubmit = async (event) => {
    ...
    // remove the condition after check
